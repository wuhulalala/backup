...
class ViT_Decoder(nn.Module):
    ...
    def __init__(
        ...
        # 统一使用 Linear 层避免网格状伪影
        # 注意：如果确实需要 ConvTranspose2d（例如兼容预训练模型），可以取消下面的注释
        # use_conv_transpose = img_size[0] > 200 or img_size[1] > 200
        ...
        self.final = nn.Linear(
            embed_dim,
            out_chans * patch_size[0] * patch_size[1],
            bias=False,
        )
